...
const navItems: { id: RouteId; label: string; path: string; Icon: typeof LayoutDashboard }[] = [
  ...
  { id: 'intersections', label: 'Intersections',  path: '/intersections', Icon: MapPin          },
      ...
      <div className="px-4 py-5 flex items-center gap-3 border-b border-border min-h-[69px]">
        ...
        {!sidebarCollapsed && (
          <div className="overflow-hidden">
            ...
            <div className="text-xs text-muted-foreground whitespace-nowrap">Traffic AI Platform</div>
          </div>
        )}
      </div>
